    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="contact.php" class="selected animsition-link">Contact</a></li>
            </ul>
        </nav>
    </header>
    <div id="wrapper">
                    ...
                    <form class="form" id="form1" method="post" action="contact.php">
                        ...
                        <p class="name">
                            <input class="validate[required,custom[onlyLetter],length[0,100]] feedback-input"
                                   placeholder="Name*" type="text" id="field-nom" name="field-nom"
                        ...
                        <p class="email">
                            <input placeholder="Email*" type="text"
                                   class="validate[required,custom[email]] feedback-input" id="field-mail"
                                   name="field-mail"
                                   value="<?php if (isset($_POST['field-mail'])) echo $_POST['field-mail']; ?>"
                                   tabindex="26"/>
                        </p>

                        <p class="text">
                            <textarea class="validate[required,length[6,300]] feedback-input" placeholder="Comment*"
                                      id="field-mess" name="field-mess"
                                      tabindex="28"><?php if (isset($_POST['field-mess'])) echo $_POST['field-mess']; ?></textarea>
                        </p>
